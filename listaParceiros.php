...
<div class="container"><br>
    <h2>
      <a href='cadParc.php'>
        <img src="_image/iconeParceiro.png" alt="Incluir Parceiro" width="45" height="45">
      </a>Nossos Parceiros
      ...
      <tbody>
        ...
        if ($result = $mysqli->query($sql)) {
          while ($row = $result->fetch_assoc()) {
            echo "<tr><td>
                  <a href='sysParceiroAlterar.php?id=" . $row["id_parc"] . "'>
                      <span class='glyphicon glyphicon-pencil'></span>
                  </a>

                  <a href='sysParceiroExcluirOk.php?id=" . $row["id_parc"] . "'>
